...
import { resizeAspectRatio, setupText, updateText} from '/hw7_2021147610/util/util.js';
import { Shader, readShaderFile } from '/hw7_2021147610/util/shader.js';
import { Cube } from '/hw7_2021147610/util/cube.js';
import { Arcball } from '/hw7_2021147610/util/arcball.js';
...
async function initShader() {
    ...
    const shPhongVertexShaderSource = await readShaderFile('shPhongVert.glsl');
    const shPhongFragmentShaderSource = await readShaderFile('shPhongFrag.glsl');
    phongShader = new Shader(gl, shPhongVertexShaderSource, shPhongFragmentShaderSource);


    const shGouraudVertexShaderSource = await readShaderFile('shGouraudVert.glsl');
    const shGouraudFragmentShaderSource = await readShaderFile('shGouraudFrag.glsl');
    gouraudShader = new Shader(gl, shGouraudVertexShaderSource, shGouraudFragmentShaderSource);
